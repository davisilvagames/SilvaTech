...
export default function About() {
  ...
  return (
    <Section id="empresa" className="py-[100px] sm:py-[140px]">
      <div className="max-w-[1200px] mx-auto px-6">
        <div ref={ref} className="grid md:grid-cols-2 gap-16 lg:gap-20 items-center">
          <div
          ...
          >
            ...
            <p className="text-text-secondary leading-relaxed mb-5 text-base sm:text-lg">
          ...
          >
            <div className="relative rounded-2xl border border-border bg-bg-card p-8 sm:p-10 overflow-hidden">
