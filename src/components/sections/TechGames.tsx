          ...
          <div className="relative p-8 sm:p-12">
            ...
            <div className="grid sm:grid-cols-3 gap-4 mb-8">
              {[
                ...
                <div
                  key={item.label}
                  className="rounded-lg border border-border bg-bg-card/50 p-4 hover:border-secondary/30 transition-all duration-300"
                  style={{ transitionDelay: `${i * 100}ms` }}
                >
                  <h3 className="text-text-primary font-medium text-sm mb-1">{item.label}</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg bg-secondary text-white font-medium text-sm hover:bg-secondary/90 transition-all duration-200"
              >
